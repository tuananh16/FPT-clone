...
function Cart() {
  ...
  return (
    <div className="wrap-child">
      <div className="header-detail" style={{ width: "774px" }}>
        <ul>
          <li>Trang chủ</li>
          <li>Giỏ hàng</li>
        </ul>
          ...
          <div className="product-cart">
            ...
            <div className="product-cart-info">
              <div className="product-cart-inside">
                ...
                <a href="/">
                  Thu gọn khuyến mãi <i className="fa-solid fa-chevron-up" />
                </a>
                <ul style={{ width: "340px" }}>
                  <li style={{ display: "flex" }}>
                    ...
                    <div>
                      <span>
                        Giảm ngay 600.000đ và hoàn tiền đến 500.000đ khi mở thẻ
                        đồng thương hiệu TPBANK EVO
                      </span>
                    </div>
                  </li>
                  <li style={{ display: "flex" }}>
                    ...
                    <div>
                      <span>
                        Giảm ngay 5% tối đa 500.000 đồng khi thanh toán trả góp
                        6/12 tháng qua Kredivo
                      </span>
                    </div>
                  </li>
                </ul>
